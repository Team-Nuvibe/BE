...
public enum NotificationType {
    ...
    NOTI_07("NOTI-07","TAG_RECOMMENDATION","오늘의 추천 태그 {{tag}} — 떠오르는 바이브가 있나요?", "미션", "오늘의 추천 태그가 도착했어요", "{{tag}} 태그로 바이브를 드랍해 볼까요?"),
    NOTI_08("NOTI-08","WEEKLY_RECAP_CREATED","이번 주의 바이브 톤이 정리됐어요.", "알림", "이번 주의 바이브 톤이 정리됐어요", "한주의 흐름을 확인해 보세요!"),
    NOTI_09("NOTI-09","FULL_RECAP_UPDATED","지금까지 쌓인 바이브 톤을 한 번에 볼 수 있어요.", "알림", "전체 바이브톤이 정리됐어요", "지금까지 쌓인 바이브를 확인해 볼까요?"),
    NOTI_10("NOTI-10","PASSWORD_CHANGED",null, "알림", "비밀번호가 변경됐어요", "보안을 다시 확인해 볼까요?"),
    NOTI_11("NOTI-11","NICKNAME_CHANGED",null, "알림", "닉네임이 변경됐어요", "14일 후 다시 변경할 수 있어요");
