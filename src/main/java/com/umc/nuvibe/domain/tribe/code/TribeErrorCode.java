...
public enum TribeErrorCode implements ErrorCode {
    ...
    ALREADY_CREATED_VERSION(HttpStatus.BAD_REQUEST, "TRIBE4003", "이미 동일한 버전의 트라이브가 존재합니다."),
    TRIBE_JOIN_RETRY_EXCEEDED(HttpStatus.BAD_REQUEST, "TRIBE4004", "트라이브 입장 시도 횟수 제한을 초과하였습니다.");
